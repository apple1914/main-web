...
const blockchainToDepositSettings = {
  bsc: {
    ...
    address: {
      am: process.env.BSC_INCOMING_ADDRESS_PUBLIC_KEY,
      pm: process.env.BSC_INCOMING_ADDRESS_PUBLIC_KEY,
    },
  },
  tron: {
    cryptocurrency: {
    ...
    address: {
      am: process.env.process.env.TRON_BYPASS_PUBLIC_KEY_AM,
      pm: process.env.TRON_BYPASS_PUBLIC_KEY_PM,
    },
  },
  polygon: {
    cryptocurrency: {
    ...
    address: {
      am: process.env.POLYGON_INCOMING_ADDRESS_PUBLIC_KEY,
      pm: process.env.POLYGON_INCOMING_ADDRESS_PUBLIC_KEY,
    },
  },
  ethereum: {
    cryptocurrency: {
    ...
    address: {
      am: process.env.ETHEREUM_INCOMING_ADDRESS_PUBLIC_KEY,
      pm: process.env.ETHEREUM_INCOMING_ADDRESS_PUBLIC_KEY,
    },
  },
};
...
export const createOnramp = (input) => {
  ...
  const amPmString = amOrPmSchedNow();
  const address = depositCryptoSettings.address[amPmString];
