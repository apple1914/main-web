...
export default function TransakExplainerWhyCrypto() {
  ...
  return (
    <>
      <button 
        className="btn text-primary mx-1 w-100 mx-auto"
        onClick={handleShow}
      >
        {t("transakExplainerWhyCrypto.button")}
      </button>

      <Modal show={show} onHide={handleClose} centered>
        <div className="modal-header">
          <h5 className="modal-title fw-400">{t("transakExplainerWhyCrypto.title")}</h5>
         
        </div>
        <div className="modal-body p-0 bg-white rounded px-3">
          <h6 className="modal-title fw-400">
            {t("transakExplainerWhyCrypto.p1")}
          </h6>
          <h6 className="modal-text fw-400">
            {t("transakExplainerWhyCrypto.p2")}
          </h6>
          <button
                type="button"
