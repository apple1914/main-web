...
export default function TransakExplainerSatefy() {
  ...
  return (
    <>
      <button 
        ...
        onClick={handleShow}
      >
        {t("transakExplainerSafety.button")}
      </button>

      <Modal show={show} onHide={handleClose} centered>
        <div className="modal-header">
          <h5 className="modal-title fw-400">{t("transakExplainerSafety.title")}</h5>
         
        </div>
        <div className="modal-body p-0 bg-white rounded px-3">
          <h6 className="modal-title fw-400">
            {t("transakExplainerSafety.p1")}
          </h6>
          <h6 className="modal-text fw-400">
            {t("transakExplainerSafety.p2")}
          </h6>
          <button
                type="button"
